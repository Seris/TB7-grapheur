...
char exposerErreur(err_t erreur)
{
    ...
    case NO_ERR:
        ...
        break;
    case PAR_NON_FERM:
        printf("PAR_NON_FERM pas utilise.\n");
        break;
    case PAR_MANQ:
        printf("PAR_MANQ pas utilise.\n");
        break;
    case MAUV_TOK:
        indiquerPosition(erreur.token.position + 4);
        printf("Formule incoherente.\n");
        break;
    case MANQ_TOK:
        indiquerPosition(erreur.token.position + 4);
        printf("Element manquant.\n");
        break;
    case MAUV_REEL:
        indiquerPosition(erreur.token.position + 4);
        printf("Reel illegal.\n");
...
int lancer_interface(int ac, char *av[])
{
    ...
    adaptationEchelle();
    InitGraph(ac, av, "Fen�tre", 1000, 700, dessin, frappe);
